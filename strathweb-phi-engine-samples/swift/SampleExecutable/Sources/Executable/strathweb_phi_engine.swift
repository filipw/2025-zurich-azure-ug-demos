...
public struct FfiConverterTypePhiModelProvider: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PhiModelProvider {
        ...
        case 3: return .fileSystem(
            indexPath: try FfiConverterString.read(from: &buf), 
            configPath: try FfiConverterString.read(from: &buf)
        )
        
        case 4: return .fileSystemGguf(
...
fileprivate let foreignCallbackCallbackInterfacePhiEventHandler : ForeignCallback =
    ...
    func invokeOnInferenceStarted(_ swiftCallbackInterface: PhiEventHandler, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        func makeCall() throws -> Int32 {
            try swiftCallbackInterface.onInferenceStarted(
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        do {
    ...
    func invokeOnInferenceEnded(_ swiftCallbackInterface: PhiEventHandler, _ argsData: UnsafePointer<UInt8>, _ argsLen: Int32, _ out_buf: UnsafeMutablePointer<RustBuffer>) throws -> Int32 {
        func makeCall() throws -> Int32 {
            try swiftCallbackInterface.onInferenceEnded(
                    )
            return UNIFFI_CALLBACK_SUCCESS
        }
        do {
    ...
    switch method {
        ...
        case 3:
            ...
            do {
                return try invokeOnInferenceStarted(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
        case 4:
            ...
            do {
                return try invokeOnInferenceEnded(cb, argsData, argsLen, out_buf)
            } catch let error {
                out_buf.pointee = FfiConverterString.lower(String(describing: error))
                return UNIFFI_CALLBACK_UNEXPECTED_ERROR
            }
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_strathweb_phi_engine_checksum_method_phieventhandler_on_inference_started() != 62753) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_strathweb_phi_engine_checksum_method_phieventhandler_on_inference_ended() != 12526) {
        return InitializationResult.apiChecksumMismatch
    }
